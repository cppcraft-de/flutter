...
DEFAULT_GROUPS = list(PATCH_GROUP_ORDER)

GROUP_MARKERS = {
    'diagnostics': {
        ('skia', 'modules/skparagraph/include/Metrics.h'): 'fRawAscent',
        ('skia', 'modules/skparagraph/include/Paragraph.h'): 'GlyphDiagnostic',
