...
/* #define FT_CONFIG_OPTION_ERROR_STRINGS */
   ...
   */
  // [SCHOOLCRAFT]:
  // Disabled, since the bitmap variations of fonts (e.g. in Calibri) result in
  // a heuristical determination of the ascender/descender metrics. And thus
  // wrong metrics. Bitmap variations are legacy and not needed anymore.
  // For details see [HS1372].
